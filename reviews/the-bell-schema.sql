-- The-Bell schema for Supabase SQL editor
-- Generated 2026-09-23 from drizzle/0000_colorful_triton.sql
...
ALTER TABLE "deliveries" ADD CONSTRAINT "deliveries_notice_id_notices_id_fk" FOREIGN KEY ("notice_id") REFERENCES "public"."notices"("id") ON DELETE no action ON UPDATE no action;

ALTER TABLE "notices" ADD CONSTRAINT "notices_edition_id_gazette_editions_id_fk" FOREIGN KEY ("edition_id") REFERENCES "public"."gazette_editions"("id") ON DELETE no action ON UPDATE no action;

ALTER TABLE "notices" ADD CONSTRAINT "notices_corrects_notice_id_notices_id_fk" FOREIGN KEY ("corrects_notice_id") REFERENCES "public"."notices"("id") ON DELETE no action ON UPDATE no action;

ALTER TABLE "notices" ADD CONSTRAINT "notices_revokes_notice_id_notices_id_fk" FOREIGN KEY ("revokes_notice_id") REFERENCES "public"."notices"("id") ON DELETE no action ON UPDATE no action;

ALTER TABLE "payments" ADD CONSTRAINT "payments_subscriber_id_subscribers_id_fk" FOREIGN KEY ("subscriber_id") REFERENCES "public"."subscribers"("id") ON DELETE no action ON UPDATE no action;
